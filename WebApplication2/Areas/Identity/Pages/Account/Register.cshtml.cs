...
namespace WebApplication2.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = new WebApplication2User { UserName = Input.Username, Email = Input.Email, Surname = Input.Surname, FirstName = Input.FirstName, MiddleName = Input.MiddleName, EmployeeNumber = Input.EmployeeNumber };
